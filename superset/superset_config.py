...
SQLALCHEMY_DATABASE_URI = os.getenv(
    "SQLALCHEMY_DATABASE_URI", "sqlite:////home/superset/db/caravel.db")
...
# Flask App Builder, the web framework used by SUPERSET. Please consult the
# Flask App Builder Documentation for more information on how to configure
# SUPERSET: http://flask-appbuilder.readthedocs.org/en/latest/config.html